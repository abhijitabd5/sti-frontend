...
const VerifyCertificateModal = ({ isOpen, onClose }) => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      const data = await publicCertificateApi.verifyCertificate(certificateNumber.trim());
          ...
          <form onSubmit={handleVerify} className="mb-6">
            ...
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                disabled={loading}
              />
              <button
                type="submit"
                disabled={loading}
                className="px-6 py-3 bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 font-semibold rounded-lg hover:from-yellow-500 hover:to-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center gap-2"
              >
                {loading ? (
                  <>
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300">This certificate is valid and authentic</p>
                </div>
              </div>
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                        ...
                        <span className="text-sm">{certificateData.student?.user?.email}</span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                        <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                        <span className="text-sm">{certificateData.student?.user?.mobile}</span>
                      </div>
                    </div>
                  </div>
                </div>
