...
function OnlineEnquiries() {
  ...
  const [activeTab, setActiveTab] = useState('course'); // 'course' or 'contact_us'
  ...
  useEffect(() => {
    loadEnquiries();
  }, [page, limit, filterStatus, activeTab]);
    ...
    <AdminLayout>
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          View and manage enquiries from website visitors
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700/60">
        <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700/60">
          <h3 className="text-lg font-medium text-gray-800 dark:text-gray-100">
            {activeTab === 'course' ? 'Course' : 'Contact Us'} Enquiries ({pagination.total || 0})
          </h3>
        </div>
