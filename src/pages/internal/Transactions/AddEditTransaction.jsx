  ...
  const validateForm = () => {
    ...
    if (formData.payment_ref_num && !formData.payment_ref_type) {
      newErrors.payment_ref_type =
        "Payment reference type is required when reference number is provided";
    }
    ...
    if (formData.attachment && !formData.attachment_type) {
      newErrors.attachment_type =
        "Attachment type is required when attachment is provided";
    }
    ...
    <AdminLayout>
      ...
      <div className="mb-8" id="headerSection">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                {isEdit ? "Update" : "Create a new"} {transactionType}{" "}
                transaction record
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
          >
            {isExpanded ? (
              <>
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700/60">
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("payment_ref_num", e.target.value)
                      }
                      className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 transition-colors ${
                  ...
                  {formData.payment_ref_num && (
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleInputChange("payment_ref_type", e.target.value)
                        }
                        className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 transition-colors ${
          ...
          {/* Person Details Section - Optional Fields */}
          {isExpanded && (
            <div>
              <h3 className="text-lg font-medium text-gray-800 dark:text-gray-100 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={
                      transactionType === "income"
                        ? formData.payer_contact
                        : formData.payee_contact
                    }
                    onChange={(e) =>
                      handleInputChange(
                        transactionType === "income"
                ...
                <div>
                  ...
                  <input
                    ...
                    value={
                      transactionType === "income"
                        ? formData.payer_bank_name
                        : formData.payee_bank_name
                    }
                    onChange={(e) =>
                      handleInputChange(
                        transactionType === "income"
                ...
                <div>
                  ...
                  <input
                    ...
                    value={
                      transactionType === "income"
                        ? formData.payer_account_number
                        : formData.payee_account_number
                    }
                    onChange={(e) =>
                      handleInputChange(
                        transactionType === "income"
                ...
                <div>
                  ...
                  <input
                    ...
                    value={
                      transactionType === "income"
                        ? formData.payer_upi_id
                        : formData.payee_upi_id
                    }
                    onChange={(e) =>
                      handleInputChange(
                        transactionType === "income"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {formData.attachment && (
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleInputChange("attachment_type", e.target.value)
                          }
                          className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 transition-colors ${
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("reference_note", e.target.value)
                    }
                    className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-700/60 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
